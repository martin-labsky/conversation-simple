...
{"solr_cluster_id":"scc8bfea20_a47f_4f55_bd46_bf161e274e5f","cluster_name":"","cluster_size":"","solr_cluster_status":"NOT_AVAILABLE"}

curl -u "7e83c21e-d9cf-4366-b3ba-0fd9a0ddf741":"B7WfEORAEZqL" "https://gateway.watsonplatform.net/retrieve-and-rank/api/v1/solr_clusters/scc8bfea20_a47f_4f55_bd46_bf161e274e5f"

curl -X POST -H "Content-Type: application/zip" -u "7e83c21e-d9cf-4366-b3ba-0fd9a0ddf741":"B7WfEORAEZqL" "https://gateway.watsonplatform.net/retrieve-and-rank/api/v1/solr_clusters/scc8bfea20_a47f_4f55_bd46_bf161e274e5f/config/coco_config" --data-binary @cranfield-solr-config.zip
...
curl -X POST -u "7e83c21e-d9cf-4366-b3ba-0fd9a0ddf741":"B7WfEORAEZqL" "https://gateway.watsonplatform.net/retrieve-and-rank/api/v1/solr_clusters/scc8bfea20_a47f_4f55_bd46_bf161e274e5f/solr/admin/collections" -d "action=CREATE&name=coco_collection&collection.configName=coco_config"
...
curl -X POST -H "Content-Type: application/json" -u "7e83c21e-d9cf-4366-b3ba-0fd9a0ddf741":"B7WfEORAEZqL" "https://gateway.watsonplatform.net/retrieve-and-rank/api/v1/solr_clusters/scc8bfea20_a47f_4f55_bd46_bf161e274e5f/solr/coco_collection/update" --data-binary @rnr.json

{"responseHeader":{"status":0,"QTime":547}}

https://7e83c21e-d9cf-4366-b3ba-0fd9a0ddf741:B7WfEORAEZqL@gateway.watsonplatform.net/retrieve-and-rank/api/v1/solr_clusters/scc8bfea20_a47f_4f55_bd46_bf161e274e5f/solr/coco_collection/select?q=expression&wt=json&fl=id,title,author
